...
export function AnnexTeachersPage() {
  ...
  const { data: annexTeachers = [], isLoading } = useGetAnnexTeachersQuery(
    annex.id!
  );
    ...
    <div className="flex gap-6 p-6">
      <div className="flex-1 flex flex-col gap-3 min-w-0">
        <h2 className="text-base font-semibold">
          {t('pages.draftAnnex.teachers.inAnnex')}
        </h2>
        <div
      ...
      <div className="flex-1 flex flex-col gap-3 min-w-0">
        <h2 className="text-base font-semibold">
          {t('pages.draftAnnex.teachers.available')}
        </h2>
          ...
          {availableTeachers.length === 0 ? (
            ...
            availableTeachers.map((teacher) => (
              <div
                ...
                onDragStart={(e) =>
                  e.dataTransfer.setData('teacherId', String(teacher.id))
                }
